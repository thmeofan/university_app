...
import 'cost_and_duration.dart'; // Replace with your actual file path
            ...
            children: <Widget>[
              ...
              Row(
                children: [
                  ...
                  Spacer(),
                  TextButton(
                    onPressed: () => _addNewProConField(_prosControllers),
                    child: Text(
                      'Agregar',
              ...
              Row(
                children: [
                  ...
                  Spacer(),
                  TextButton(
                    onPressed: () => _addNewProConField(_consControllers),
                    child: Text(
                      'Agregar',
                      style: ConstructorTextStyle.add,
                    ),
